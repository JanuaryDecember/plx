<template>
  <div class="d-flex bg-secondary shadow mb-3">
    ...
    <NuxtLink class="btn btn-secondary m-2 text-white" to="/listings">Other user's approved listings</NuxtLink>
    <NuxtLink class="btn btn-secondary my-2 text-white" to="/admin" v-if="isAdmin()">Admin panel</NuxtLink>
    <div class="ms-auto">
...
function isAdmin() {
  return useCookie("permitted").value;
}
